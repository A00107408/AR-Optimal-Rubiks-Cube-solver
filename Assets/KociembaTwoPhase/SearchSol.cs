        ...
        public static string Solution(string facelets, int maxDepth, long timeOut, bool useSeparator)
        {
            ...
            // +++++++++++++++++++++check for wrong input +++++++++++++++++++++++++++++
                    /*    int[] count = new int[6];
                        ...
                        for (int i = 0; i < 54; i++)
                        {
            //count[Colors.valueOf(facelets.Substring(i, 1)).ordinal()]++;
                            count[(int)Enum.Parse(typeof(Color), facelets.Substring(i, 1))]++;                                 
                        }
